...
export function LineChartPreview({ lineChartStyle, palette, titleChrome, subtitleChrome, titleFallback = "", spaceBelowTitle = 0, spaceAboveSubtitle = 0, spaceBelowSubtitle = 0 }: Props) {
  /**
  ...
  const authoredInner = authoredInnerBox(LINE_CHART_BOX, authoredChromeExtent([titleBand, subtitleBand, legendBand]));
  ...
  return (
    <PresentationScale width={LINE_CHART_BOX.width}><span
      ...
      style={authoredRootStyle({ opacity: 1 - lineChartStyle.plotArea.transparency / 100, width: LINE_CHART_BOX.width, height: LINE_CHART_BOX.height }, topChromeBand, legendBand)}
    >
