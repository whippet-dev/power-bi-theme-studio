...
export const BAR_CHART_PROPERTIES = {
  ...
  labels: {
    ...
    enableDetailDataLabel: boolProp("clusteredBarChart", "bar.labels.enableDetailDataLabel", "Enable Detail Data Label", "Whether the enable detail data label is turned on.", ["labels", 0, "enableDetailDataLabel"], undefined, "Value"),
    enableTitleDataLabel: boolProp("clusteredBarChart", "bar.labels.enableTitleDataLabel", "Enable Title Data Label", "Whether the enable title data label is turned on.", ["labels", 0, "enableTitleDataLabel"], undefined, "Value"),
    enableValueDataLabel: boolProp("clusteredBarChart", "bar.labels.enableValueDataLabel", "Enable Value Data Label", "Whether the enable value data label is turned on.", ["labels", 0, "enableValueDataLabel"], undefined, "Value"),
