...
export const BAR_CHART_PROPERTIES = {
  ...
  dataPoint: {
    borderColor: colorProp("clusteredBarChart", "bar.dataPoint.borderColor", "Color", "The colour of the border.", ["dataPoint", 0, "borderColor"]),
    borderColorMatchFill: boolProp("clusteredBarChart", "bar.dataPoint.borderColorMatchFill", "Match fill color", "Match the border color to the main shape color.", ["dataPoint", 0, "borderColorMatchFill"]),
    borderShow: boolProp("clusteredBarChart", "bar.dataPoint.borderShow", "Border", "Whether the border is shown.", ["dataPoint", 0, "borderShow"]),
    borderSize: numberProp("clusteredBarChart", "bar.dataPoint.borderSize", "Width", "The thickness, in pixels, of the border.", ["dataPoint", 0, "borderSize"], 0, 10),
    borderTransparency: numberProp("clusteredBarChart", "bar.dataPoint.borderTransparency", "Transparency", "How see-through the border appears — 0 is solid, 100 is invisible.", ["dataPoint", 0, "borderTransparency"], 0, 100),
    defaultColor: colorProp("clusteredBarChart", "bar.dataPoint.defaultColor", "Default color", "The main colour used for the bars.", ["dataPoint", 0, "defaultColor"]),
    fill: colorProp("clusteredBarChart", "bar.dataPoint.fill", "Color", "The main colour used for the bars.", ["dataPoint", 0, "fill"]),
    fillTransparency: numberProp("clusteredBarChart", "bar.dataPoint.fillTransparency", "Transparency", "How see-through the fill appears — 0 is solid, 100 is invisible.", ["dataPoint", 0, "fillTransparency"], 0, 100),
  },
  ...
  categoryAxis: {
    ...
    gridlineAutoScale: boolProp("clusteredBarChart", "bar.categoryAxis.gridlineAutoScale", "Scale by width", "Automatically adjust the spacing between dashes and dots based on line width.", ["categoryAxis", 0, "gridlineAutoScale"]),
    gridlineColor: colorProp("clusteredBarChart", "bar.categoryAxis.gridlineColor", "Color", "The colour of the gridline.", ["categoryAxis", 0, "gridlineColor"]),
    gridlineDashArray: textProp("clusteredBarChart", "bar.categoryAxis.gridlineDashArray", "Dash array", "Space-separated values for dash and gap lengths in pixels, repeating in sequence.", ["categoryAxis", 0, "gridlineDashArray"]),
    gridlineDashCap: enumProp("clusteredBarChart", "bar.categoryAxis.gridlineDashCap", "Dash cap", "Sets the gridline dash cap.", ["categoryAxis", 0, "gridlineDashCap"], [{"value":"none","label":"Flat"},{"value":"round","label":"Round"},{"value":"square","label":"Square"}] as const),
    gridlineShow: boolProp("clusteredBarChart", "bar.categoryAxis.gridlineShow", "Show", "Whether the gridline is shown.", ["categoryAxis", 0, "gridlineShow"]),
    gridlineStyle: enumProp("clusteredBarChart", "bar.categoryAxis.gridlineStyle", "Line style", "Sets the gridline's line style.", ["categoryAxis", 0, "gridlineStyle"], [{"value":"solid","label":"Solid"},{"value":"dashed","label":"Dashed"},{"value":"dotted","label":"Dotted"},{"value":"custom","label":"Custom"}] as const),
    gridlineThickness: numberProp("clusteredBarChart", "bar.categoryAxis.gridlineThickness", "Width", "The thickness, in pixels, of the gridline.", ["categoryAxis", 0, "gridlineThickness"], 0, 10),
    gridlineTransparency: numberProp("clusteredBarChart", "bar.categoryAxis.gridlineTransparency", "Transparency", "How see-through the gridline appears — 0 is solid, 100 is invisible.", ["categoryAxis", 0, "gridlineTransparency"], 0, 100),
    ...
    labelColor: colorProp("clusteredBarChart", "bar.categoryAxis.labelColor", "Color", "The colour of the label.", ["categoryAxis", 0, "labelColor"]),
    ...
    titleBold: boolProp("clusteredBarChart", "bar.categoryAxis.titleBold", "Bold", "Whether the title is bold.", ["categoryAxis", 0, "titleBold"]),
    titleColor: colorProp("clusteredBarChart", "bar.categoryAxis.titleColor", "Title color", "The colour of the title.", ["categoryAxis", 0, "titleColor"]),
    titleFontFamily: textProp("clusteredBarChart", "bar.categoryAxis.titleFontFamily", "Font family", "The typeface used for the title.", ["categoryAxis", 0, "titleFontFamily"]),
    titleFontSize: numberProp("clusteredBarChart", "bar.categoryAxis.titleFontSize", "Title text size", "Sets the title's title text size.", ["categoryAxis", 0, "titleFontSize"], 8, 60),
    titleItalic: boolProp("clusteredBarChart", "bar.categoryAxis.titleItalic", "Italic", "Whether the title is italic.", ["categoryAxis", 0, "titleItalic"]),
    titleText: textProp("clusteredBarChart", "bar.categoryAxis.titleText", "Axis title", "The custom text used for the title.", ["categoryAxis", 0, "titleText"]),
    titleUnderline: boolProp("clusteredBarChart", "bar.categoryAxis.titleUnderline", "Underline", "Whether the title is underlined.", ["categoryAxis", 0, "titleUnderline"]),
  ...
  valueAxis: {
    ...
    gridlineAutoScale: boolProp("clusteredBarChart", "bar.valueAxis.gridlineAutoScale", "Scale by width", "Automatically adjust the spacing between dashes and dots based on line width.", ["valueAxis", 0, "gridlineAutoScale"]),
    gridlineColor: colorProp("clusteredBarChart", "bar.valueAxis.gridlineColor", "Color", "The colour of the gridline.", ["valueAxis", 0, "gridlineColor"]),
    gridlineDashArray: textProp("clusteredBarChart", "bar.valueAxis.gridlineDashArray", "Dash array", "Space-separated values for dash and gap lengths in pixels, repeating in sequence.", ["valueAxis", 0, "gridlineDashArray"]),
    gridlineDashCap: enumProp("clusteredBarChart", "bar.valueAxis.gridlineDashCap", "Dash cap", "Sets the gridline dash cap.", ["valueAxis", 0, "gridlineDashCap"], [{"value":"none","label":"Flat"},{"value":"round","label":"Round"},{"value":"square","label":"Square"}] as const),
    gridlineShow: boolProp("clusteredBarChart", "bar.valueAxis.gridlineShow", "Show", "Whether the gridline is shown.", ["valueAxis", 0, "gridlineShow"]),
    gridlineStyle: enumProp("clusteredBarChart", "bar.valueAxis.gridlineStyle", "Line style", "Sets the gridline's line style.", ["valueAxis", 0, "gridlineStyle"], [{"value":"solid","label":"Solid"},{"value":"dashed","label":"Dashed"},{"value":"dotted","label":"Dotted"},{"value":"custom","label":"Custom"}] as const),
    gridlineThickness: numberProp("clusteredBarChart", "bar.valueAxis.gridlineThickness", "Width", "The thickness, in pixels, of the gridline.", ["valueAxis", 0, "gridlineThickness"], 0, 10),
    gridlineTransparency: numberProp("clusteredBarChart", "bar.valueAxis.gridlineTransparency", "Transparency", "How see-through the gridline appears — 0 is solid, 100 is invisible.", ["valueAxis", 0, "gridlineTransparency"], 0, 100),
    ...
    labelColor: colorProp("clusteredBarChart", "bar.valueAxis.labelColor", "Color", "The colour of the label.", ["valueAxis", 0, "labelColor"]),
    ...
    titleBold: boolProp("clusteredBarChart", "bar.valueAxis.titleBold", "Bold", "Whether the title is bold.", ["valueAxis", 0, "titleBold"]),
    titleColor: colorProp("clusteredBarChart", "bar.valueAxis.titleColor", "Title color", "The colour of the title.", ["valueAxis", 0, "titleColor"]),
    titleFontFamily: textProp("clusteredBarChart", "bar.valueAxis.titleFontFamily", "Font family", "The typeface used for the title.", ["valueAxis", 0, "titleFontFamily"]),
    titleFontSize: numberProp("clusteredBarChart", "bar.valueAxis.titleFontSize", "Title text size", "Sets the title's title text size.", ["valueAxis", 0, "titleFontSize"], 8, 60),
    titleItalic: boolProp("clusteredBarChart", "bar.valueAxis.titleItalic", "Italic", "Whether the title is italic.", ["valueAxis", 0, "titleItalic"]),
    titleText: textProp("clusteredBarChart", "bar.valueAxis.titleText", "Axis title", "The custom text used for the title.", ["valueAxis", 0, "titleText"]),
    titleUnderline: boolProp("clusteredBarChart", "bar.valueAxis.titleUnderline", "Underline", "Whether the title is underlined.", ["valueAxis", 0, "titleUnderline"]),
  ...
  legend: {
    ...
    labelColor: colorProp("clusteredBarChart", "bar.legend.labelColor", "Color", "The colour of the label.", ["legend", 0, "labelColor"]),
    ...
    showGradientLegend: boolProp("clusteredBarChart", "bar.legend.showGradientLegend", "Show", "Whether the show gradient legend is turned on.", ["legend", 0, "showGradientLegend"]),
    showTitle: boolProp("clusteredBarChart", "bar.legend.showTitle", "Title", "Display a title for legend symbols", ["legend", 0, "showTitle"]),
    titleText: textProp("clusteredBarChart", "bar.legend.titleText", "Legend Name", "Title text", ["legend", 0, "titleText"]),
  ...
  labels: {
    backgroundColor: colorProp("clusteredBarChart", "bar.labels.backgroundColor", "Color", "Background color", ["labels", 0, "backgroundColor"]),
    backgroundTransparency: numberProp("clusteredBarChart", "bar.labels.backgroundTransparency", "Transparency", "Background color transparency", ["labels", 0, "backgroundTransparency"], 0, 100),
    bold: boolProp("clusteredBarChart", "bar.labels.bold", "Bold", "Whether the data labels's text is bold.", ["labels", 0, "bold"]),
    color: colorProp("clusteredBarChart", "bar.labels.color", "Color", "Select color for data labels", ["labels", 0, "color"]),
    detailBold: boolProp("clusteredBarChart", "bar.labels.detailBold", "Bold", "Whether the detail is bold.", ["labels", 0, "detailBold"]),
    detailColor: colorProp("clusteredBarChart", "bar.labels.detailColor", "Color", "Select color for data labels", ["labels", 0, "detailColor"]),
    detailContentType: enumProp("clusteredBarChart", "bar.labels.detailContentType", "Content", "Sets the detail content type.", ["labels", 0, "detailContentType"], [{"value":"Percent of total","label":"Percent of total"},{"value":"Custom","label":"Custom"}] as const),
    detailCustomFormatString: textProp("clusteredBarChart", "bar.labels.detailCustomFormatString", "Format code", "Enter a custom number format for your callout.", ["labels", 0, "detailCustomFormatString"]),
    detailFontFamily: textProp("clusteredBarChart", "bar.labels.detailFontFamily", "Font family", "The typeface used for the detail.", ["labels", 0, "detailFontFamily"]),
    detailFontSize: numberProp("clusteredBarChart", "bar.labels.detailFontSize", "Text size", "Sets the detail's text size.", ["labels", 0, "detailFontSize"], 8, 60),
    detailFormatString: textProp("clusteredBarChart", "bar.labels.detailFormatString", "Detail Format String", "The custom text used for the detail format string.", ["labels", 0, "detailFormatString"]),
    detailItalic: boolProp("clusteredBarChart", "bar.labels.detailItalic", "Italic", "Whether the detail is italic.", ["labels", 0, "detailItalic"]),
    detailLabelDisplayUnits: enumProp("clusteredBarChart", "bar.labels.detailLabelDisplayUnits", "Display units", "Select the units (millions, billions, etc.)", ["labels", 0, "detailLabelDisplayUnits"], [{"value":0,"label":"Auto"},{"value":1,"label":"None"},{"value":1000,"label":"Thousands"},{"value":1000000,"label":"Millions"},{"value":1000000000,"label":"Billions"},{"value":1000000000000,"label":"Trillions"},{"value":-1,"label":"Custom"}] as const),
    detailLabelPrecision: numberProp("clusteredBarChart", "bar.labels.detailLabelPrecision", "Value decimal places", "Select the number of decimal places to display for the values", ["labels", 0, "detailLabelPrecision"], 0, 10),
    detailShowBlankAs: textProp("clusteredBarChart", "bar.labels.detailShowBlankAs", "Show blank as", "The custom text used for the detail show blank as.", ["labels", 0, "detailShowBlankAs"]),
    detailTransparency: numberProp("clusteredBarChart", "bar.labels.detailTransparency", "Transparency", "How see-through the detail appears — 0 is solid, 100 is invisible.", ["labels", 0, "detailTransparency"], 0, 100),
    detailUnderline: boolProp("clusteredBarChart", "bar.labels.detailUnderline", "Underline", "Whether the detail is underlined.", ["labels", 0, "detailUnderline"]),
    enableBackground: boolProp("clusteredBarChart", "bar.labels.enableBackground", "Show background", "Whether the enable background is turned on.", ["labels", 0, "enableBackground"]),
    enableDetailDataLabel: boolProp("clusteredBarChart", "bar.labels.enableDetailDataLabel", "Enable Detail Data Label", "Whether the enable detail data label is turned on.", ["labels", 0, "enableDetailDataLabel"]),
    enableTitleDataLabel: boolProp("clusteredBarChart", "bar.labels.enableTitleDataLabel", "Enable Title Data Label", "Whether the enable title data label is turned on.", ["labels", 0, "enableTitleDataLabel"]),
    enableValueDataLabel: boolProp("clusteredBarChart", "bar.labels.enableValueDataLabel", "Enable Value Data Label", "Whether the enable value data label is turned on.", ["labels", 0, "enableValueDataLabel"]),
    fontFamily: textProp("clusteredBarChart", "bar.labels.fontFamily", "Font family", "The typeface used for the data labels.", ["labels", 0, "fontFamily"]),
    fontSize: numberProp("clusteredBarChart", "bar.labels.fontSize", "Text size", "Sets the data labels's text size.", ["labels", 0, "fontSize"], 8, 60),
    horizontalAlignment: enumProp("clusteredBarChart", "bar.labels.horizontalAlignment", "Horizontal alignment", "Sets the horizontal alignment.", ["labels", 0, "horizontalAlignment"], [{"value":"left","label":"left"},{"value":"center","label":"center"},{"value":"right","label":"right"}] as const),
    italic: boolProp("clusteredBarChart", "bar.labels.italic", "Italic", "Whether the data labels's text is italic.", ["labels", 0, "italic"]),
    labelContainerMaxWidth: numberProp("clusteredBarChart", "bar.labels.labelContainerMaxWidth", "Maximum width", "Sets the label container max width.", ["labels", 0, "labelContainerMaxWidth"], -1000, 1000),
    labelContentLayout: enumProp("clusteredBarChart", "bar.labels.labelContentLayout", "Layout", "Sets the label content layout.", ["labels", 0, "labelContentLayout"], [{"value":"MultiLine","label":"Multi-line"},{"value":"SingleLine","label":"Single line"}] as const),
    labelDensity: numberProp("clusteredBarChart", "bar.labels.labelDensity", "Label density", "Sets the label density.", ["labels", 0, "labelDensity"], -1000, 1000),
    ...
    labelOrientation: enumProp("clusteredBarChart", "bar.labels.labelOrientation", "Orientation", "Sets the label orientation.", ["labels", 0, "labelOrientation"], [{"value":0,"label":"Vertical"},{"value":1,"label":"Horizontal"}] as const),
    labelOverflow: boolProp("clusteredBarChart", "bar.labels.labelOverflow", "Overflow text", "Allow the labels to overflow outside of the shape's boundaries", ["labels", 0, "labelOverflow"]),
    labelPosition: enumProp("clusteredBarChart", "bar.labels.labelPosition", "Position", "Sets the label position.", ["labels", 0, "labelPosition"], [{"value":"Auto","label":"Auto"},{"value":"InsideEnd","label":"Inside end"},{"value":"OutsideEnd","label":"Outside end"},{"value":"InsideCenter","label":"Inside center"},{"value":"InsideBase","label":"Inside base"},{"value":"Above","label":"Above"},{"value":"Under","label":"Under"}] as const),
    labelPrecision: numberProp("clusteredBarChart", "bar.labels.labelPrecision", "Value decimal places", "Select the number of decimal places to display for the values", ["labels", 0, "labelPrecision"], 0, 10),
    optimizeLabelDisplay: boolProp("clusteredBarChart", "bar.labels.optimizeLabelDisplay", "Optimize label display", "Whether the optimize label display is turned on.", ["labels", 0, "optimizeLabelDisplay"]),
    show: boolProp("clusteredBarChart", "bar.labels.show", "Show", "Whether the data labels are shown.", ["labels", 0, "show"]),
    showAll: boolProp("clusteredBarChart", "bar.labels.showAll", "Customize series", "Whether the show all is turned on.", ["labels", 0, "showAll"]),
    showBlankAs: textProp("clusteredBarChart", "bar.labels.showBlankAs", "Show blank as", "The custom text used for the show blank as.", ["labels", 0, "showBlankAs"]),
    showByDefault: boolProp("clusteredBarChart", "bar.labels.showByDefault", "Show By Default", "Whether the show by default is turned on.", ["labels", 0, "showByDefault"]),
    showDynamicLabels: boolProp("clusteredBarChart", "bar.labels.showDynamicLabels", "Custom label", "Whether the show dynamic labels is turned on.", ["labels", 0, "showDynamicLabels"]),
    showSeries: boolProp("clusteredBarChart", "bar.labels.showSeries", "Show", "Whether the show series is turned on.", ["labels", 0, "showSeries"]),
    titleBold: boolProp("clusteredBarChart", "bar.labels.titleBold", "Bold", "Whether the title is bold.", ["labels", 0, "titleBold"]),
    titleColor: colorProp("clusteredBarChart", "bar.labels.titleColor", "Color", "Select color for data labels", ["labels", 0, "titleColor"]),
    titleContentType: enumProp("clusteredBarChart", "bar.labels.titleContentType", "Content", "Sets the title content type.", ["labels", 0, "titleContentType"], [{"value":"Series name","label":"Series name"},{"value":"Custom","label":"Custom"}] as const),
    titleCustomFormatString: textProp("clusteredBarChart", "bar.labels.titleCustomFormatString", "Format code", "Enter a custom number format for your callout.", ["labels", 0, "titleCustomFormatString"]),
    titleFontFamily: textProp("clusteredBarChart", "bar.labels.titleFontFamily", "Font family", "The typeface used for the title.", ["labels", 0, "titleFontFamily"]),
    titleFontSize: numberProp("clusteredBarChart", "bar.labels.titleFontSize", "Text size", "Sets the title's text size.", ["labels", 0, "titleFontSize"], 8, 60),
    titleFormatString: textProp("clusteredBarChart", "bar.labels.titleFormatString", "Title Format String", "The custom text used for the title format string.", ["labels", 0, "titleFormatString"]),
    titleItalic: boolProp("clusteredBarChart", "bar.labels.titleItalic", "Italic", "Whether the title is italic.", ["labels", 0, "titleItalic"]),
    ...
    titleLabelPrecision: numberProp("clusteredBarChart", "bar.labels.titleLabelPrecision", "Value decimal places", "Select the number of decimal places to display for the values", ["labels", 0, "titleLabelPrecision"], 0, 10),
    titleShowBlankAs: textProp("clusteredBarChart", "bar.labels.titleShowBlankAs", "Show blank as", "The custom text used for the title show blank as.", ["labels", 0, "titleShowBlankAs"]),
    titleTransparency: numberProp("clusteredBarChart", "bar.labels.titleTransparency", "Transparency", "How see-through the title appears — 0 is solid, 100 is invisible.", ["labels", 0, "titleTransparency"], 0, 100),
    titleUnderline: boolProp("clusteredBarChart", "bar.labels.titleUnderline", "Underline", "Whether the title is underlined.", ["labels", 0, "titleUnderline"]),
    transparency: numberProp("clusteredBarChart", "bar.labels.transparency", "Transparency", "How see-through the data labels appears — 0 is solid, 100 is invisible.", ["labels", 0, "transparency"], 0, 100),
    underline: boolProp("clusteredBarChart", "bar.labels.underline", "Underline", "Whether the data labels's text is underlined.", ["labels", 0, "underline"]),
    valueCustomFormatString: textProp("clusteredBarChart", "bar.labels.valueCustomFormatString", "Format code", "Enter a custom number format for your callout.", ["labels", 0, "valueCustomFormatString"]),
    valueFormatString: textProp("clusteredBarChart", "bar.labels.valueFormatString", "Value Format String", "The custom text used for the value format string.", ["labels", 0, "valueFormatString"]),
    wordWrap: boolProp("clusteredBarChart", "bar.labels.wordWrap", "Word wrap", "Whether the word wrap is turned on.", ["labels", 0, "wordWrap"]),
  },
  ...
  error: {
    barBorderColor: colorProp("clusteredBarChart", "bar.error.barBorderColor", "Border color", "The colour of the bar border.", ["error", 0, "barBorderColor"]),
    barBorderSize: numberProp("clusteredBarChart", "bar.error.barBorderSize", "Border size", "Sets the bar border's border size.", ["error", 0, "barBorderSize"], 0, 10),
    barColor: colorProp("clusteredBarChart", "bar.error.barColor", "Bar color", "The colour of the bar.", ["error", 0, "barColor"]),
    barMatchSeriesColor: boolProp("clusteredBarChart", "bar.error.barMatchSeriesColor", "Match series color", "Whether the bar match series is turned on.", ["error", 0, "barMatchSeriesColor"]),
    barShow: boolProp("clusteredBarChart", "bar.error.barShow", "Show", "Whether the bar is shown.", ["error", 0, "barShow"]),
    barWidth: numberProp("clusteredBarChart", "bar.error.barWidth", "Width", "The thickness, in pixels, of the bar width.", ["error", 0, "barWidth"], 0, 10),
    enabled: boolProp("clusteredBarChart", "bar.error.enabled", "Enabled", "Whether the enabled is turned on.", ["error", 0, "enabled"]),
    labelBackground: boolProp("clusteredBarChart", "bar.error.labelBackground", "Show background", "Whether the label background is turned on.", ["error", 0, "labelBackground"]),
    labelBackgroundColor: colorProp("clusteredBarChart", "bar.error.labelBackgroundColor", "Background color", "The colour of the label background.", ["error", 0, "labelBackgroundColor"]),
    labelBackgroundTransparency: numberProp("clusteredBarChart", "bar.error.labelBackgroundTransparency", "Transparency", "Background color transparency", ["error", 0, "labelBackgroundTransparency"], 0, 100),
    labelBold: boolProp("clusteredBarChart", "bar.error.labelBold", "Bold", "Whether the label is bold.", ["error", 0, "labelBold"]),
    labelColor: colorProp("clusteredBarChart", "bar.error.labelColor", "Color", "The colour of the label.", ["error", 0, "labelColor"]),
    labelFontFamily: textProp("clusteredBarChart", "bar.error.labelFontFamily", "Font family", "The typeface used for the label.", ["error", 0, "labelFontFamily"]),
    labelFontSize: numberProp("clusteredBarChart", "bar.error.labelFontSize", "Text size", "Sets the label's text size.", ["error", 0, "labelFontSize"], 8, 60),
    labelFormat: enumProp("clusteredBarChart", "bar.error.labelFormat", "Label format", "Sets the label format.", ["error", 0, "labelFormat"], [{"value":"absolute","label":"Absolute"},{"value":"relativeNumeric","label":"Relative (numeric)"},{"value":"relativePercentage","label":"Relative (percentage)"},{"value":"range","label":"Range"}] as const),
    labelItalic: boolProp("clusteredBarChart", "bar.error.labelItalic", "Italic", "Whether the label is italic.", ["error", 0, "labelItalic"]),
    labelMatchSeriesColor: boolProp("clusteredBarChart", "bar.error.labelMatchSeriesColor", "Match series color", "Whether the label match series is turned on.", ["error", 0, "labelMatchSeriesColor"]),
    labelShow: boolProp("clusteredBarChart", "bar.error.labelShow", "Show", "Whether the label is shown.", ["error", 0, "labelShow"]),
    labelUnderline: boolProp("clusteredBarChart", "bar.error.labelUnderline", "Underline", "Whether the label is underlined.", ["error", 0, "labelUnderline"]),
    markerShape: enumProp("clusteredBarChart", "bar.error.markerShape", "Marker shape", "Sets the marker shape.", ["error", 0, "markerShape"], [{"value":"circle","label":"●"},{"value":"square","label":"■"},{"value":"diamond","label":"◆"},{"value":"triangle","label":"▲"},{"value":"x","label":"☓"},{"value":"shortDash","label":" -"},{"value":"longDash","label":"—"},{"value":"plus","label":"+"},{"value":"none","label":"None"}] as const),
    markerShow: boolProp("clusteredBarChart", "bar.error.markerShow", "Show", "Whether the marker is shown.", ["error", 0, "markerShow"]),
    markerSize: numberProp("clusteredBarChart", "bar.error.markerSize", "Size", "Sets the marker's size.", ["error", 0, "markerSize"], 1, 60),
    tooltipFormat: enumProp("clusteredBarChart", "bar.error.tooltipFormat", "Label format", "Sets the tooltip format.", ["error", 0, "tooltipFormat"], [{"value":"absolute","label":"Absolute"},{"value":"relativeNumeric","label":"Relative (numeric)"},{"value":"relativePercentage","label":"Relative (percentage)"},{"value":"range","label":"Range"}] as const),
    tooltipShow: boolProp("clusteredBarChart", "bar.error.tooltipShow", "Show in tooltip", "Whether the tooltip is shown.", ["error", 0, "tooltipShow"]),
  },
  ...
  referenceLine: {
    ...
    dataLabelColor: colorProp("clusteredBarChart", "bar.referenceLine.dataLabelColor", "Color", "Set the reference line data label color", ["referenceLine", 0, "dataLabelColor"]),
    dataLabelDecimalPoints: numberProp("clusteredBarChart", "bar.referenceLine.dataLabelDecimalPoints", "Value decimal places", "Sets the data label decimal points's value decimal places.", ["referenceLine", 0, "dataLabelDecimalPoints"], 0, 10),
    ...
    dataLabelHorizontalPosition: enumProp("clusteredBarChart", "bar.referenceLine.dataLabelHorizontalPosition", "Horizontal position", "Set the horizontal position for the reference line data label", ["referenceLine", 0, "dataLabelHorizontalPosition"], [{"value":"left","label":"Left"},{"value":"right","label":"Right"}] as const),
    dataLabelShow: boolProp("clusteredBarChart", "bar.referenceLine.dataLabelShow", "Data label", "Display a data label for the reference line", ["referenceLine", 0, "dataLabelShow"]),
    dataLabelText: enumProp("clusteredBarChart", "bar.referenceLine.dataLabelText", "Text", "Text shown in the label", ["referenceLine", 0, "dataLabelText"], [{"value":"Value","label":"Data value"},{"value":"Name","label":"Name"},{"value":"ValueAndName","label":"Both"}] as const),
    dataLabelVerticalPosition: enumProp("clusteredBarChart", "bar.referenceLine.dataLabelVerticalPosition", "Vertical position", "Set the vertical position for the reference line data label", ["referenceLine", 0, "dataLabelVerticalPosition"], [{"value":"above","label":"Above"},{"value":"under","label":"Under"}] as const),
    ...
    shadeColor: colorProp("clusteredBarChart", "bar.referenceLine.shadeColor", "Shade color", "The colour of the shade.", ["referenceLine", 0, "shadeColor"]),
    shadeColorMatchStroke: boolProp("clusteredBarChart", "bar.referenceLine.shadeColorMatchStroke", "Match line color", "Match the legend icon color to the color of the line, not the marker", ["referenceLine", 0, "shadeColorMatchStroke"]),
    shadeRegion: enumProp("clusteredBarChart", "bar.referenceLine.shadeRegion", "Shade region", "Sets the shade region.", ["referenceLine", 0, "shadeRegion"], [{"value":"before","label":"Before"},{"value":"after","label":"After"},{"value":"none","label":"None"}] as const),
    shadeShow: boolProp("clusteredBarChart", "bar.referenceLine.shadeShow", "Show", "Whether the shade is shown.", ["referenceLine", 0, "shadeShow"]),
    shadeTransparency: numberProp("clusteredBarChart", "bar.referenceLine.shadeTransparency", "Shade transparency", "How see-through the shade appears — 0 is solid, 100 is invisible.", ["referenceLine", 0, "shadeTransparency"], 0, 100),
  ...
  xAxisReferenceLine: {
    ...
    dataLabelColor: colorProp("clusteredBarChart", "bar.xAxisReferenceLine.dataLabelColor", "Color", "Set the reference line data label color", ["xAxisReferenceLine", 0, "dataLabelColor"]),
    dataLabelDecimalPoints: numberProp("clusteredBarChart", "bar.xAxisReferenceLine.dataLabelDecimalPoints", "Value decimal places", "Sets the data label decimal points's value decimal places.", ["xAxisReferenceLine", 0, "dataLabelDecimalPoints"], 0, 10),
    ...
    dataLabelHorizontalPosition: enumProp("clusteredBarChart", "bar.xAxisReferenceLine.dataLabelHorizontalPosition", "Horizontal position", "Set the horizontal position for the reference line data label", ["xAxisReferenceLine", 0, "dataLabelHorizontalPosition"], [{"value":"left","label":"Left"},{"value":"right","label":"Right"}] as const),
    dataLabelShow: boolProp("clusteredBarChart", "bar.xAxisReferenceLine.dataLabelShow", "Data label", "Display a data label for the reference line", ["xAxisReferenceLine", 0, "dataLabelShow"]),
    dataLabelText: enumProp("clusteredBarChart", "bar.xAxisReferenceLine.dataLabelText", "Text", "Text shown in the label", ["xAxisReferenceLine", 0, "dataLabelText"], [{"value":"Value","label":"Data value"},{"value":"Name","label":"Name"},{"value":"ValueAndName","label":"Both"}] as const),
    dataLabelVerticalPosition: enumProp("clusteredBarChart", "bar.xAxisReferenceLine.dataLabelVerticalPosition", "Vertical position", "Set the vertical position for the reference line data label", ["xAxisReferenceLine", 0, "dataLabelVerticalPosition"], [{"value":"above","label":"Above"},{"value":"under","label":"Under"}] as const),
    ...
    shadeColor: colorProp("clusteredBarChart", "bar.xAxisReferenceLine.shadeColor", "Shade color", "The colour of the shade.", ["xAxisReferenceLine", 0, "shadeColor"]),
    shadeColorMatchStroke: boolProp("clusteredBarChart", "bar.xAxisReferenceLine.shadeColorMatchStroke", "Match line color", "Match the legend icon color to the color of the line, not the marker", ["xAxisReferenceLine", 0, "shadeColorMatchStroke"]),
    shadeRegion: enumProp("clusteredBarChart", "bar.xAxisReferenceLine.shadeRegion", "Shade region", "Sets the shade region.", ["xAxisReferenceLine", 0, "shadeRegion"], [{"value":"before","label":"Before"},{"value":"after","label":"After"},{"value":"none","label":"None"}] as const),
    shadeShow: boolProp("clusteredBarChart", "bar.xAxisReferenceLine.shadeShow", "Show", "Whether the shade is shown.", ["xAxisReferenceLine", 0, "shadeShow"]),
    shadeTransparency: numberProp("clusteredBarChart", "bar.xAxisReferenceLine.shadeTransparency", "Shade transparency", "How see-through the shade appears — 0 is solid, 100 is invisible.", ["xAxisReferenceLine", 0, "shadeTransparency"], 0, 100),
  ...
  y1AxisReferenceLine: {
    ...
    dataLabelColor: colorProp("clusteredBarChart", "bar.y1AxisReferenceLine.dataLabelColor", "Color", "Set the reference line data label color", ["y1AxisReferenceLine", 0, "dataLabelColor"]),
    dataLabelDecimalPoints: numberProp("clusteredBarChart", "bar.y1AxisReferenceLine.dataLabelDecimalPoints", "Value decimal places", "Sets the data label decimal points's value decimal places.", ["y1AxisReferenceLine", 0, "dataLabelDecimalPoints"], 0, 10),
    ...
    dataLabelHorizontalPosition: enumProp("clusteredBarChart", "bar.y1AxisReferenceLine.dataLabelHorizontalPosition", "Horizontal position", "Set the horizontal position for the reference line data label", ["y1AxisReferenceLine", 0, "dataLabelHorizontalPosition"], [{"value":"left","label":"Left"},{"value":"right","label":"Right"}] as const),
    dataLabelShow: boolProp("clusteredBarChart", "bar.y1AxisReferenceLine.dataLabelShow", "Data label", "Display a data label for the reference line", ["y1AxisReferenceLine", 0, "dataLabelShow"]),
    dataLabelText: enumProp("clusteredBarChart", "bar.y1AxisReferenceLine.dataLabelText", "Text", "Text shown in the label", ["y1AxisReferenceLine", 0, "dataLabelText"], [{"value":"Value","label":"Data value"},{"value":"Name","label":"Name"},{"value":"ValueAndName","label":"Both"}] as const),
    dataLabelVerticalPosition: enumProp("clusteredBarChart", "bar.y1AxisReferenceLine.dataLabelVerticalPosition", "Vertical position", "Set the vertical position for the reference line data label", ["y1AxisReferenceLine", 0, "dataLabelVerticalPosition"], [{"value":"above","label":"Above"},{"value":"under","label":"Under"}] as const),
    ...
    shadeColor: colorProp("clusteredBarChart", "bar.y1AxisReferenceLine.shadeColor", "Shade color", "The colour of the shade.", ["y1AxisReferenceLine", 0, "shadeColor"]),
    shadeColorMatchStroke: boolProp("clusteredBarChart", "bar.y1AxisReferenceLine.shadeColorMatchStroke", "Match line color", "Match the legend icon color to the color of the line, not the marker", ["y1AxisReferenceLine", 0, "shadeColorMatchStroke"]),
    shadeRegion: enumProp("clusteredBarChart", "bar.y1AxisReferenceLine.shadeRegion", "Shade region", "Sets the shade region.", ["y1AxisReferenceLine", 0, "shadeRegion"], [{"value":"before","label":"Before"},{"value":"after","label":"After"},{"value":"none","label":"None"}] as const),
    shadeShow: boolProp("clusteredBarChart", "bar.y1AxisReferenceLine.shadeShow", "Show", "Whether the shade is shown.", ["y1AxisReferenceLine", 0, "shadeShow"]),
    shadeTransparency: numberProp("clusteredBarChart", "bar.y1AxisReferenceLine.shadeTransparency", "Shade transparency", "How see-through the shade appears — 0 is solid, 100 is invisible.", ["y1AxisReferenceLine", 0, "shadeTransparency"], 0, 100),
  ...
  zoom: {
    categoryMax: numberProp("clusteredBarChart", "bar.zoom.categoryMax", "Category Max", "Sets the category max.", ["zoom", 0, "categoryMax"], -1000, 1000),
    categoryMin: numberProp("clusteredBarChart", "bar.zoom.categoryMin", "Category Min", "Sets the category min.", ["zoom", 0, "categoryMin"], -1000, 1000),
    categorySize: numberProp("clusteredBarChart", "bar.zoom.categorySize", "Category Size", "Sets the category's category size.", ["zoom", 0, "categorySize"], 1, 60),
    ...
    showOnCategoryAxis: boolProp("clusteredBarChart", "bar.zoom.showOnCategoryAxis", "Y axis", "Whether the show on category axis is turned on.", ["zoom", 0, "showOnCategoryAxis"]),
    showOnValueAxis: boolProp("clusteredBarChart", "bar.zoom.showOnValueAxis", "X axis", "Whether the show on value axis is turned on.", ["zoom", 0, "showOnValueAxis"]),
    ...
    valueMax: numberProp("clusteredBarChart", "bar.zoom.valueMax", "Value Max", "Sets the value max.", ["zoom", 0, "valueMax"], -1000, 1000),
    valueMin: numberProp("clusteredBarChart", "bar.zoom.valueMin", "Value Min", "Sets the value min.", ["zoom", 0, "valueMin"], -1000, 1000),
    valueSize: numberProp("clusteredBarChart", "bar.zoom.valueSize", "Value Size", "Sets the value's value size.", ["zoom", 0, "valueSize"], 1, 60),
  },

  smallMultiplesLayout: {
    advancedPaddingOptions: boolProp("clusteredBarChart", "bar.smallMultiplesLayout.advancedPaddingOptions", "Advanced padding options", "Whether the advanced padding options is turned on.", ["smallMultiplesLayout", 0, "advancedPaddingOptions"]),
    backgroundColor: colorProp("clusteredBarChart", "bar.smallMultiplesLayout.backgroundColor", "Background color", "Background color for each small multiple", ["smallMultiplesLayout", 0, "backgroundColor"]),
    backgroundTransparency: numberProp("clusteredBarChart", "bar.smallMultiplesLayout.backgroundTransparency", "Background transparency", "Background color transparency", ["smallMultiplesLayout", 0, "backgroundTransparency"], 0, 100),
    columnCount: numberProp("clusteredBarChart", "bar.smallMultiplesLayout.columnCount", "Columns", "Sets the column count's columns.", ["smallMultiplesLayout", 0, "columnCount"], 1, 12),
    columnPaddingInner: numberProp("clusteredBarChart", "bar.smallMultiplesLayout.columnPaddingInner", "Inner column padding", "Sets the column padding inner's inner column padding.", ["smallMultiplesLayout", 0, "columnPaddingInner"], 0, 50),
    columnPaddingOuter: numberProp("clusteredBarChart", "bar.smallMultiplesLayout.columnPaddingOuter", "Outer column padding", "Sets the column padding outer's outer column padding.", ["smallMultiplesLayout", 0, "columnPaddingOuter"], 0, 50),
    gridLineColor: colorProp("clusteredBarChart", "bar.smallMultiplesLayout.gridLineColor", "Color", "The colour of the grid line.", ["smallMultiplesLayout", 0, "gridLineColor"]),
    gridLineShow: boolProp("clusteredBarChart", "bar.smallMultiplesLayout.gridLineShow", "Show", "Whether the grid line is shown.", ["smallMultiplesLayout", 0, "gridLineShow"]),
    gridLineStyle: enumProp("clusteredBarChart", "bar.smallMultiplesLayout.gridLineStyle", "Line style", "Sets the grid line's line style.", ["smallMultiplesLayout", 0, "gridLineStyle"], [{"value":"solid","label":"Solid"},{"value":"dashed","label":"Dashed"},{"value":"dotted","label":"Dotted"}] as const),
    gridLineTransparency: numberProp("clusteredBarChart", "bar.smallMultiplesLayout.gridLineTransparency", "Transparency", "How see-through the grid line appears — 0 is solid, 100 is invisible.", ["smallMultiplesLayout", 0, "gridLineTransparency"], 0, 100),
    gridLineType: enumProp("clusteredBarChart", "bar.smallMultiplesLayout.gridLineType", "Gridlines", "Gridlines to delineate the small multiple visuals", ["smallMultiplesLayout", 0, "gridLineType"], [{"value":"all","label":"All"},{"value":"inner","label":"Horizontal and vertical"},{"value":"innerHorizontal","label":"Horizontal only"},{"value":"innerVertical","label":"Vertical only"}] as const),
    gridLineWidth: numberProp("clusteredBarChart", "bar.smallMultiplesLayout.gridLineWidth", "Width", "The thickness, in pixels, of the grid line width.", ["smallMultiplesLayout", 0, "gridLineWidth"], 0, 10),
    gridPadding: numberProp("clusteredBarChart", "bar.smallMultiplesLayout.gridPadding", "Grid padding", "Sets the grid padding.", ["smallMultiplesLayout", 0, "gridPadding"], 0, 50),
    layoutType: enumProp("clusteredBarChart", "bar.smallMultiplesLayout.layoutType", "Grid layout", "Sets the layout type.", ["smallMultiplesLayout", 0, "layoutType"], [{"value":"auto","label":"Auto"},{"value":"custom","label":"Custom"}] as const),
    rowCount: numberProp("clusteredBarChart", "bar.smallMultiplesLayout.rowCount", "Rows", "Sets the row count's rows.", ["smallMultiplesLayout", 0, "rowCount"], 1, 12),
    rowPaddingInner: numberProp("clusteredBarChart", "bar.smallMultiplesLayout.rowPaddingInner", "Inner row padding", "Sets the row padding inner's inner row padding.", ["smallMultiplesLayout", 0, "rowPaddingInner"], 0, 50),
    rowPaddingOuter: numberProp("clusteredBarChart", "bar.smallMultiplesLayout.rowPaddingOuter", "Outer row padding", "Sets the row padding outer's outer row padding.", ["smallMultiplesLayout", 0, "rowPaddingOuter"], 0, 50),
  },
 ...
 */
export function resolveBarChartStyle(theme: PowerBITheme, base: ResolvedTheme): ResolvedBarChartStyle {
  ...
  return {
    ...
    error: {
      ...
      barWidth: resolvePropertyValue(theme, p.error.barWidth, 0),
    ...
    smallMultiplesLayout: {
      ...
      gridLineWidth: resolvePropertyValue(theme, p.smallMultiplesLayout.gridLineWidth, 0),
