...
import { CARTESIAN_NATIVE, LINE_NATIVE, MARK_NATIVE } from "./cartesianNativeDefaults";
import { nativeDataColor, nativeToken } from "./nativeTokens";
...
export function resolveLineChartStyle(theme: ThemeSource, base: ResolvedTheme): ResolvedLineChartStyle {
  ...
  const seriesLabelText = resolveTextRole(theme, "seriesLabel");
  ...
  return {
    ...
    lineStyles: {
      ...
      areaMatchStrokeColor: resolvePropertyValue(theme, p.lineStyles.areaMatchStrokeColor, LINE_NATIVE.shadeAreaMatchStrokeColor),
      areaShow: resolvePropertyValue(theme, p.lineStyles.areaShow, false),
      markerColor: resolvePropertyValue(theme, p.lineStyles.markerColor, nativeDataColor(theme, 0)),
      markerShape: resolvePropertyValue(theme, p.lineStyles.markerShape, "circle"),
      markerSize: resolvePropertyValue(theme, p.lineStyles.markerSize, LINE_NATIVE.markerSize),
      ...
      strokeLineJoin: resolvePropertyValue(theme, p.lineStyles.strokeLineJoin, LINE_NATIVE.strokeLineJoin),
      ...
      strokeWidth: resolvePropertyValue(theme, p.lineStyles.strokeWidth, MARK_NATIVE.line.strokeWidth),
    },
    markers: {
    ...
    seriesLabels: {
      ...
      seriesColor: resolvePropertyValue(theme, p.seriesLabels.seriesColor, seriesLabelText.color),
      seriesFontFamily: resolvePropertyValue(theme, p.seriesLabels.seriesFontFamily, seriesLabelText.fontFamily),
      seriesMatchColor: resolvePropertyValue(theme, p.seriesLabels.seriesMatchColor, LINE_NATIVE.seriesLabelMatchColor),
      seriesMaximumWidth: resolvePropertyValue(theme, p.seriesLabels.seriesMaximumWidth, 0),
      seriesPosition: resolvePropertyValue(theme, p.seriesLabels.seriesPosition, LINE_NATIVE.seriesLabelPosition),
      ...
      textSize: resolvePropertyValue(theme, p.seriesLabels.textSize, seriesLabelText.fontSize),
      underline: resolvePropertyValue(theme, p.seriesLabels.underline, false),
      backgroundColor: resolvePropertyValue(theme, p.seriesLabels.backgroundColor, nativeToken(theme, "backgroundDark")),
      backgroundMatchColor: resolvePropertyValue(theme, p.seriesLabels.backgroundMatchColor, false),
      backgroundTransparency: resolvePropertyValue(theme, p.seriesLabels.backgroundTransparency, LINE_NATIVE.seriesLabelBackgroundTransparency),
      enableBackground: resolvePropertyValue(theme, p.seriesLabels.enableBackground, LINE_NATIVE.seriesLabelBackgroundShow),
      leaderLineAutoScale: resolvePropertyValue(theme, p.seriesLabels.leaderLineAutoScale, false),
      leaderLineColor: resolvePropertyValue(theme, p.seriesLabels.leaderLineColor, nativeToken(theme, "foregroundNeutralSecondary")),
      ...
      leaderLines: resolvePropertyValue(theme, p.seriesLabels.leaderLines, LINE_NATIVE.seriesLabelLeaderLineShow),
    },
    plotArea: {
